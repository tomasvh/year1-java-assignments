...
public class CountrySort {
	...
	public static int countA (String s1) {
		return (int) s1.toLowerCase().chars().filter(ch -> ch == 'a').count();
	}
	...
	public static void main(String[] args) {
		...
		Comparator<String> reverseAlphabetic = (s1,s2) -> s2.compareToIgnoreCase(s1);
		...
		Comparator<String> countAs = (s1,s2) -> countA(s2) - countA(s1) ;
